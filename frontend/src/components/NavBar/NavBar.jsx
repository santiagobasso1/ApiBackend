...
const Navbar = () => {
  ...
  <nav className={"navbar navbar-expand-lg fixed-top navbar-dark navbarPersonal"}>
    <div className='botonesNavbar'>
        <button className='botonNavbar botonPrincipalNavBar'><Link className='nav-link' to={"/"}>3er Entrega Proyecto Final</Link></button>
        ...
        <button className='botonNavbar'><Link className='nav-link' to={"/products"}>Productos(VerNotas)</Link></button>
